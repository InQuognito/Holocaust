...
def walk():
	...
	if not logic.recall_memory("Ate Food"):
		...
		logic.print_text("As you walk, you take notice of the local bakery; the food smells delicious, but you just ate; there wouldn't be any point in going inside.")

	if logic.recall_memory("Completed Game"):
		logic.print_text("As you approach the edge of town, your headache grows unbearable. You feel that something terrible waits ahead for you, and you consider turning back and concluding your walk when you hear faint noises coming from the alleyway up ahead.\nAs you approach, you become increasingly worried; it sounds as if someone is in trouble.\nYou try to take stock of the situation; is someone being mugged?\nYou have no weapons to defend yourself with, and you consider turning back. However, your concern gets the best of you, and you try to approach as quietly as possible to take stock of the situation.\n\nYou weren't prepared for the sight in front of you as you peered around the corner; on the ground lay a man, cowering, covered in blood; he makes little noise besides the occasional whimpering and pleading.\nHis lip has been split open, and his face is covered in dirt from the ground.\nSurrounding him were two larger men, who refused to let him off the ground. Any attempt at diplomacy or retaliation were swiftly thwarted.\nThe sight in front of you makes you sick to your stomach; never before had you witnessed such brutality.\nAs you look closer, you begin to understand better; the man on the ground is unmistakably PATHETIC.\n\nYou have no idea what you should do in this situation; you can't leave him like this. The police won't help, certainly, and you have no way to defend yourself.\nBut should you try anyways?")
	...
	if (choice == 1):
		if logic.recall_memory("Completed Game"):
			logic.print_text("As you begin to approach the man, your head feels like it splits in two.\nYour feet stop in place, and you recieve and extremely strong feeling that you should not help at all. Almost as if doing so will cause something terrible to happen.\nTry as you might, you cannot make your feet march into the alley; is it fear? Intuition? Self-preservation? Whatever it may be, your gut gets the best of you and you turn to leave. As you walk away, you hear the man muster all of his strength to plead for someone to help one final time.")

		else:
			logic.print_text("You stick with your gut and decide to do what is right. As you examine your surroundings for anything that can help, you notice a piece of metal pipe laying on the ground.\nAt this point, neither of the men have seen you; this should be easy. You continue sneaking up, careful not to alert the men ahead.\nYou pick up the pipe as quietly as possible and continue moving forward. Soon, you are right behing the men who still are not aware of your presence.\n\nYou hesitate for a moment; you have never hurt somebody before, and you aren't excited to do it now. However, you know this needs to be done; the man on the ground has it a lot worse than you right now.\nYou raise the pipe over your head and slam it down on top of the man on your left, who drops instantly. Before the other man can fully acknowledge what is happening, you swing the pipe sideways as it connects with a sickening crack into the mans' nose.\n\nTime slows to a crawl as you stand there holding the pipe for what feels like an eternity. Eventually, you come to your senses as the realization of what you have just done sets in.\nYou had never been in a fight before, let alone nearly killed two people. You bring your attention to the man on the ground in front of you, whose eyes contain a mix of fear and astonishment. You imagine for a moment that, to him, you surely look like a lunatic holding a pipe.\n\nAs you open your mouth to speak to him, you hear several sets of heavy footsteps behind you; it sounds like they are running.\nYou both turn towards the noise, and you see two soldiers rounding the corner; it appears to be the same two from the alleyway earlier.\nIt is apparent after a few brief moments that they are entirely unhappy about the situation in front of them, and they begin shouting frantically at you, ordering you to put the weapon down and get on the ground.\nAs you drop the pipe and attempt to explain the situation, it is clear that the two soldiers are not at all interested in what you have to say.\n\nYou must have taken slightly too long to get on the ground, because the last thing you see is a soldier running towards you before connecting a baton to the side of your skull.")

	if (choice == 2):
		logic.print_text("A little voice in the back of your head tells you that you shouldn't interfere; those who try to help the Jews tend to go on to tell few stories.\nAnd besides, what can you do? It's two against one, not to mention their size; it's an impossible task.\nYou avert your gaze, unable to look at the situation any longer. You turn around and begin to slowly walk away, but you can't cull that gnawing in your conscience. Was there more you could've done to help? Drawn attention to it? You wonder if that man may live. You can't shake the feeling that you might as well have killed him yourself.")
