...
def go_back_to_sleep():
	...
	logic.print_text("Unfortunately, toss and turn as you might, you cannot seem to get back to sleep. Oh, well; maybe it's best to get up anyways.")
